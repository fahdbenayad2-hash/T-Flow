        ...
        {filteredProducts.length === 0 ? (
          <FadeIn delay={0.2}>
            <EmptyState
              ...
              description={
                search ? `لم يتم العثور على منتجات بـ "${search}"` : 'لا توجد بيانات منتجات بعد'
              }
            />
          </FadeIn>
        ) : (
                    ...
                    <CardContent className="space-y-3">
                      ...
                      <div className="grid grid-cols-3 gap-2 text-center">
                        <div>
                          ...
                          <p className="font-mono font-bold text-[var(--status-delivered)]">
                            {product.deliveredOrders}
                          </p>
                        </div>
                        <div>
                          <p className="text-xs text-muted-foreground">قيد الانتظار</p>
                          <p className="font-mono font-bold text-[var(--status-processing)]">
                            {product.pendingOrders}
                          </p>
                        </div>
                        <div>
                          <p className="text-xs text-muted-foreground">ملغي</p>
                          <p className="font-mono font-bold text-[var(--status-cancelled)]">
