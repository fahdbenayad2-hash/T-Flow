const FEATURES = [
  {
    ...
    desc: 'مؤشرات الأداء، توزيع الحالات، وآخر النشاطات — نظرة واحدة على المتجر كله.',
  },
  {
    num: '02',
    title: 'إدارة الطلبات',
    desc: 'بحث، فرز، تحديث جماعي للحالات، وكشف تلقائي للطلبات المكررة.',
  },
  {
    num: '03',
    title: 'قاعدة العملاء',
    desc: 'تجميع تلقائي حسب رقم الهاتف، سجل الطلبات، ونسب الإلغاء لكل عميل.',
  },
  {
    num: '04',
    title: 'مركز الاتصال',
    desc: 'طابور مكالمات للوكلاء، تسجيل نتيجة كل مكالمة، وجدولة المتابعة.',
  },
  ...
  { num: '08', title: 'التقارير', desc: 'أفضل العملاء، ملخصات الحالات، وتصدير كامل إلى Excel.' },
  {
    ...
    desc: 'أدمن، وكيل تأكيد، ومسؤول شحن — كل واحد يرى ما يخصّه فقط.',
  },
]
      ...
      <div style={{ maxWidth: 1180, margin: '0 auto', paddingInline: 24 }}>
        <div className="lp-section-head">
          <div className="lp-eyebrow-light">
            <span className="lp-dot" /> 01–09 / الوحدات
          </div>
